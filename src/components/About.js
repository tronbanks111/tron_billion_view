                    ...
                    <div className="body-wrap boxed-containerbox">
                        ...
                        <main>
                            <section className="hero">
                                ...
                                <div className="containerbox" style={{ textAlign: "left", paddingTop: "30px", paddingLeft: "30px" }} > <h3 style={{ textAlign: "left", color: "black", paddingTop: "60px" }}><strong>About Us </strong></h3><br />
